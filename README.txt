...
to implement all algorithms. I also used some code I found on stack overflow for pruning.
All of my code consistes of .ipynb files because I wrote them all as Jupyter notebooks.
...
I used the first response's code for pruning:
